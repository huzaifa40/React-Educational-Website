...
import about_uni from '../Assets/about_uni.webp'
    ...
    <div className='about flex justify-center my-32'>
        <div className='w-[65%] flex gap-10 items-center'>
            <div className='relative' >
                <img src={about_uni} className='rounded-xl h-[350px] w-[780px]' alt="" />
                {/* <img src={play_icon} className='absolute top-[45%] left-[45%] h-[65px] w-[65px]' alt="" /> */}
            </div>  
            <div className=' text-start'>
                <p className='font-[600] text-[18px] text-black'>ABOUT UNIVERSITY</p>
                <h1 className='text-black font-[700] text-[40px] leading-tight mb-3 mt-1'>Nurturing Tomorrow's Leaders Today</h1>
